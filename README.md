...
Once you've set up your dev environment according to the Getting started instructions and you can run a local version
of the server by executing ./run-p2k16-web you can start developing against http://localhost:5000.
...
## LDAP Notes
    ...
    ldapsearch \
        -H ldap://:10389 \
        -b dc=bitraf,dc=no \
        -D uid=$username,ou=People,dc=bitraf,dc=no \
        uid
